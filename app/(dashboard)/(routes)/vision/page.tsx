...
export default function ConversationVision() {
  ...
  return (
    <><Heading
          ...
          bgColor="bg-green-700/5" /><div className="min-h-screen flex items-center justify-center text-md">
              <div className='min-h-screen flex flex-col items-center justify-start bg-slate-800 w-full max-w-2xl rounded-lg shadow-md p-8'>
